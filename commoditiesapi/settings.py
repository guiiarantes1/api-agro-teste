"""
Django settings for commoditiesapi project.
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:5173",  # Origem do front-end
...
ROOT_URLCONF = 'commoditiesapi.urls'
...
WSGI_APPLICATION = 'commoditiesapi.wsgi.application'
